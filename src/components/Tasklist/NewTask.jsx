...
const NewTask = ({data}) => {
  return (
    <div className='h-full flex-shrink-0 bg-green-400 w-[28vw] p-5 rounded-lg' >
    ...
    <div className='' >
        ...
        <div className='mt-8 ' >
            <button className='w-full text-white bg-green-500 rounded-md px-3 py-2' >Accept Task</button>
